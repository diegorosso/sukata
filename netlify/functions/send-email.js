export const handler = async (event) => {
  ...
  try {
    ...
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Sukata BJJ <onboarding@resend.dev>', // Cambiar por tu dominio si tenés uno verificado
        to: ['diegorosso1988@gmail.com'],                 // ← CAMBIÁ esto por tu mail real
        reply_to: email,
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #09090b; color: #ffffff; padding: 40px; border-radius: 8px;">
            ...
            <p style="margin-top: 32px; color: #3f3f46; font-size: 11px; text-align: center;">
              Mensaje enviado desde el formulario de contacto de sukata.netlify.app
            </p>
          </div>
        `,
      }),
